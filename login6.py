...
=======
       img1=Image.open(BASE_DIR/"images"/"kisspng-computer-icons-user-profile-person-5abd85306ff7f7.0592226715223698404586.jpg")
>>>>>>> 7f9d569 (Added 2fa)
...
=======
        ...
        my_cursor=conn.cursor()
        my_cursor.execute("CREATE TABLE IF NOT EXISTS register (id INT AUTO_INCREMENT PRIMARY KEY,username VARCHAR(100) NOT NULL UNIQUE,password VARCHAR(255) NOT NULL,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);")
        # my_cursor.execute("INSERT INTO register (username, password) VALUES ('admin', 'admin');")
>>>>>>> 7f9d569 (Added 2fa)
